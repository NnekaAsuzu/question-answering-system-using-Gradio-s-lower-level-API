...
questions = [
    ...
    "What technology is used in decentralized networks?",
    "What is blockchain?",
    "How are transactions verified on a blockchain?",
    "Can you name some cryptocurrencies and their purposes?",
    "How does the legal status of cryptocurrencies vary?",
    "How are cryptocurrencies viewed in the US?",
    "What are some risks associated with cryptocurrencies?",
    "What are some advantages of using cryptocurrencies?"
]
